    ...
    const handleRun = async () => {
        ...
        try {
            ...
            if (response.status === 429) {
                setRunCooldown(30);
                toast.error("You are running queries too frequently. Please wait 30 seconds before trying again.", {
                    position: "top-right",
                    theme: "colored"
                });
                setIsRunning(false);
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            >
                             ...
                             <button
                                ...
                                className={`px-4 py-1.5 border text-xs font-semibold rounded-lg disabled:opacity-50 transition-all ${runCooldown > 0 ? 'bg-gray-100 text-gray-400 border-gray-200 cursor-not-allowed' : 'bg-teal-50 text-teal-700 border-teal-200 hover:bg-teal-100 cursor-pointer'}`}
                            >
