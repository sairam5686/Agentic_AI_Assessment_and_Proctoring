...
const SebRequired: React.FC = () => {
  ...
  const slides = [
    {
      ...
      image: (
        <img src="/seb_install_dark.png" alt="Install SEB" className="w-64 h-44 object-contain mb-6 rounded-xl shadow-none" />
      )
    },
    {
      ...
      image: (
        <img src="/seb_config_dark.png" alt="Download Config" className="w-64 h-44 object-contain mb-6 rounded-xl shadow-none" />
      )
    },
    {
      ...
      image: (
         <img src="/seb_launch_dark.png" alt="Launch Assessment" className="w-64 h-44 object-contain mb-6 rounded-xl shadow-none" />
      )
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 md:p-8 font-['Outfit']">
      <div className="max-w-5xl w-full bg-white rounded-3xl shadow-[0_20px_50px_rgb(0,0,0,0.05)] border border-slate-100 overflow-hidden flex flex-col md:flex-row">
        
        {/* Left Side - Slider (Instruction) */}
        <div className="w-full md:w-1/2 p-10 flex flex-col items-center justify-center border-b md:border-b-0 border-slate-700 bg-slate-800 relative overflow-hidden">
           ...
           <div className="w-full max-w-sm bg-[#1e293b] rounded-2xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.2)] border border-slate-700 flex flex-col items-center text-center transition-all duration-500 z-10">
              {slides[currentSlide].image}
              <h3 className="text-xl font-bold text-white mb-3">{slides[currentSlide].title}</h3>
        ...
        <div className="w-full md:w-1/2 p-10 flex flex-col justify-center bg-white relative">
          ...
          <div className="flex flex-col gap-4">
            ...
            <a
              ...
              className="flex items-center p-4 bg-white hover:bg-slate-50 border border-slate-200 hover:border-slate-300 rounded-2xl transition-all shadow-sm group"
            >
              <div className="w-12 h-12 bg-indigo-50 text-indigo-600 rounded-xl flex items-center justify-center mr-4 group-hover:scale-105 transition-transform">
                <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5M16.5 12L12 16.5m0 0L7.5 12m4.5 4.5V3" />
                </svg>
              </div>
              <div className="flex-1">
                <h4 className="text-slate-800 font-bold text-sm">Download SEB</h4>
                <p className="text-slate-500 text-xs mt-0.5">Get the browser for your OS</p>
              </div>
              <div className="px-2.5 py-1 bg-indigo-50 text-indigo-600 text-xs font-bold rounded-lg border border-indigo-100">
                Step 1
              </div>
            </a>
            ...
            <a
              ...
              className="flex items-center p-4 bg-white hover:bg-slate-50 border border-slate-200 hover:border-slate-300 rounded-2xl transition-all shadow-sm group"
            >
              <div className="w-12 h-12 bg-emerald-50 text-emerald-600 rounded-xl flex items-center justify-center mr-4 group-hover:scale-105 transition-transform">
                <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
              </div>
              <div className="flex-1">
                <h4 className="text-slate-800 font-bold text-sm">Download config file</h4>
                <p className="text-slate-500 text-xs mt-0.5">TITANS_CANDIDATEPORTAL.seb</p>
              </div>
              <div className="px-2.5 py-1 bg-emerald-50 text-emerald-600 text-xs font-bold rounded-lg border border-emerald-100">
                Step 2
              </div>
            </a>
            ...
            <button
              onClick={launchInSeb}
              className="mt-4 w-full flex items-center justify-center gap-2 p-4 bg-slate-900 hover:bg-slate-800 text-white rounded-2xl font-bold transition-all active:scale-[0.98] shadow-lg shadow-slate-900/10 group"
            >
