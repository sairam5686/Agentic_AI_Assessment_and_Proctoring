...
|Candidate List (Note : Anyone who wants to test candidate workflow , download the Excel Sheet and add your registeration details in the candidate list excel sheet which we have attached here and create an test using that excel sheet with your credintials and access the candidate workflow via email ) |[Link](https://docs.google.com/spreadsheets/d/18URbRZ_ORCS5OmP3abyfPsRG45YcaIVS/edit?gid=813615534#gid=813615534)|Template to batch-register candidate profiles, unique identifier codes, allowed test permissions, and notification emails.|
---
##  About the Project
